...
fun main() {
    ...
    assert(Arrays.compare(inst.intersect(intArrayOf(2, 2, 3, 2, 2, 2), intArrayOf(2, 2, 2)), intArrayOf(2, 2, 2)) == 0)
    assert(Arrays.compare(inst.intersect(intArrayOf(0, 1, 2, 2, 1, 0), intArrayOf(2, 1, 2)), intArrayOf(2, 2)) == 0)
}